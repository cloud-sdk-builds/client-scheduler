...
[`@aws-sdk/client-scheduler`](https://www.npmjs.com/package/@aws-sdk/client-scheduler/v/3.1125.0).
...
- @aws-sdk/client-scheduler v3.1125.0 - [https://cloud-sdk-builds.github.io/?sdk=client-scheduler&version=3.1125.0](https://cloud-sdk-builds.github.io/?sdk=client-scheduler&version=3.1125.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-scheduler@3.1125.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-abUnGE80IF5r+yCgj8yvNAiCP413X1ZKpoaQxqs4P+khD7tFLbuHGoCYFWAzmsJT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-scheduler": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-scheduler@3.1125.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-scheduler@3.1125.0/index.min.mjs": "sha384-abUnGE80IF5r+yCgj8yvNAiCP413X1ZKpoaQxqs4P+khD7tFLbuHGoCYFWAzmsJT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-scheduler/blob/refs/tags/3.1125.0/LICENSE
```
