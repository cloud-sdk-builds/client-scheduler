...
[`@aws-sdk/client-scheduler`](https://www.npmjs.com/package/@aws-sdk/client-scheduler/v/3.1088.0).
...
- @aws-sdk/client-scheduler - [https://cloud-sdk-builds.github.io/?sdk=client-scheduler](https://cloud-sdk-builds.github.io/?sdk=client-scheduler)
- @aws-sdk/client-scheduler v3.1088.0 - [https://cloud-sdk-builds.github.io/?sdk=client-scheduler&version=3.1088.0](https://cloud-sdk-builds.github.io/?sdk=client-scheduler&version=3.1088.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-scheduler@3.1088.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MWLnHVWyiUWe082tEfS3gMPbu3DOTDkaq7CNLtYEZGR1QdGYUOcZoDnGXtHUJL4T
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-scheduler/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-scheduler": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-scheduler@3.1088.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-scheduler@3.1088.0/index.min.mjs": "sha384-MWLnHVWyiUWe082tEfS3gMPbu3DOTDkaq7CNLtYEZGR1QdGYUOcZoDnGXtHUJL4T"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-scheduler";
...
```
https://github.com/cloud-sdk-builds/client-scheduler/blob/refs/tags/3.1088.0/LICENSE
```
